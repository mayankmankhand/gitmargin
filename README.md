...
- [ ] **Parked, part 2:** **a publishing plugin** ([#16](https://github.com/mayankmankhand/gitmargin/issues/16)), **GitHub sign-in** ([#17](https://github.com/mayankmankhand/gitmargin/issues/17)), **Vercel same-project mode** ([#19](https://github.com/mayankmankhand/gitmargin/issues/19)).
