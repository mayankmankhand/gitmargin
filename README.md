...
- [ ] **Sign in with GitHub** ([#17](https://github.com/mayankmankhand/gitmargin/issues/17), cycle 2 of part 2). Built and tested against a stand-in GitHub in Chromium and Firefox: optional per prototype, through a GitHub App that asks for no permissions, with verified names on comments and strict reading. Its walk on the real github.com is next.
- [ ] **Parked, part 2:** **a publishing plugin** ([#16](https://github.com/mayankmankhand/gitmargin/issues/16)), **Vercel same-project mode** ([#19](https://github.com/mayankmankhand/gitmargin/issues/19)).
