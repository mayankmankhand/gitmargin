...
There is no sign-in in this mode. A key written into the page is the only gate: whoever can open the page can read and write its comments. [service/README.md](service/README.md) has the deploy steps and says plainly what that means.
