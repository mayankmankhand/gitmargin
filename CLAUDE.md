...
rather than failing silently (`docs/v0-split.md` section 5). **Part 2** (in progress; cycles 1, 2 and 3 built, cycle 4's same-project mode built ahead of cycle 3 and its GitLab Pages channel built in #37, the rest parked) = sign-in (GitHub in issue #17, GitLab through the
